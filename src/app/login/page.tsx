    ...
    <main className="flex min-h-screen items-center justify-center p-4">
      <div className="w-full max-w-sm rounded-lg border border-slate-200 border-t-4 border-t-ink bg-white p-8 shadow-sm">
        ...
        <form action={login} className="mt-6 space-y-4">
          <div>
            <label htmlFor="email" className="block text-xs font-medium text-slate">Email</label>
            <input
          ...
          <div>
            <label htmlFor="password" className="block text-xs font-medium text-slate">Password</label>
            <input
